               ...
               <div className="p-6 md:p-8 flex flex-col lg:flex-row gap-8 lg:gap-12">
                  ...
                  <div className="flex-1 space-y-8">
                     <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-4">
                        ...
                        <span className={`px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider flex items-center gap-2 ${rental.status === 'Active' ? 'bg-emerald-100 text-emerald-700' :
